...
#
# Generated by export_simulation on Mon Apr 18 14:38:10 HKT 2016
#
################################################################################
...
switch to the './end_bg.sh' script.
...
./end_bg.sh -noclean_files

For more information on the script, please type './end_bg.sh -help'.
