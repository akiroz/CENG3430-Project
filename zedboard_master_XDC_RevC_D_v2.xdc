...
# Audio Codec - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB1 [get_ports {i2c_addr[0]}];  # "AC-ADR0"
#set_property PACKAGE_PIN Y5  [get_ports {i2c_addr[1]}];  # "AC-ADR1"
#set_property PACKAGE_PIN Y8  [get_ports {i2s_data}];  # "AC-GPIO0"
#set_property PACKAGE_PIN AA7 [get_ports {AC_GPIO1}];  # "AC-GPIO1"
#set_property PACKAGE_PIN AA6 [get_ports {i2s_bclk}];  # "AC-GPIO2"
#set_property PACKAGE_PIN Y6  [get_ports {i2s_lrclk}];  # "AC-GPIO3"
#set_property PACKAGE_PIN AB2 [get_ports {i2s_mclk}];  # "AC-MCLK"
#set_property PACKAGE_PIN AB4 [get_ports {i2c_sck}];  # "AC-SCK"
#set_property PACKAGE_PIN AB5 [get_ports {i2c_sda}];  # "AC-SDA"
...
set_property PACKAGE_PIN R16 [get_ports {btn_dn}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {btn_lf}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {btn_rt}];  # "BTNR"
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets btn_dn_IBUF];
